---
title: "Architecture"
description: "This is how we build"
---
...
Validators are the backbone of Ping’s decentralized infrastructure, ensuring the network runs smoothly, securely, and efficiently. They maintain a live registry of nodes, scoring and rewarding them based on the performance. By managing node authorization and access, validators guarantee only active and compliant nodes participate in the network.
...
Ping’s economic design utilizes a Burn & Mint mechanism to ensure a balanced token economy while serving both node providers and clients. This structure seamlessly aligns supply and demand, enabling a stable and scalable decentralized network.
